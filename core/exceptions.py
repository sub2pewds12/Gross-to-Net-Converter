...
class InvalidRegionError(CoreCalculationError):
    ...
    def __init__(
        self, region_value, message="Invalid region provided for calculation."
    ):
        self.region_value = region_value
        self.message = (
            f"{message} Received: '{region_value}'. Valid regions are 1, 2, 3, 4."
        )
        super().__init__(self.message)
...
class InvalidInputDataError(CoreCalculationError):
    ...
    def __init__(
        self, field_name, field_value, reason="Invalid data provided for calculation."
    ):
...
class CalculationLogicError(CoreCalculationError):
    ...
    def __init__(
        self, message="An unexpected error occurred within the calculation logic."
    ):
        self.message = message
        super().__init__(self.message)
